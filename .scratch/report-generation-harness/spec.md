...
- The current `report_harness` package is an earlier report-generation prototype. It should be rehomed or replaced behind the new extension boundary before being treated as the Peon core.
